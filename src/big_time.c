...
#define MY_UUID {0xF1, 0xF1, 0x29, 0xD1, 0x5F, 0x87, 0x4F, 0x98, 0xB4, 0xD8, 0x31, 0x2B, 0x56, 0x8D, 0x65, 0xCE}
PBL_APP_INFO(MY_UUID, "TangoTime", "SaSConsul", 0x5, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
